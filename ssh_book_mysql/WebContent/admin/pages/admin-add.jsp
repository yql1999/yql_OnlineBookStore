...
<div id="login_frame">
    ...
    <p id="image_logo"><img src="../../images/logo.gif"></p>
        ...
        <p><label class="label_input">用户名</label><input type="text" name=admin.username"  id="username" class="text_field"/></p>
        <p><label class="label_input">密码</label><input type="text" name="admin.password" id="password" class="text_field"/></p>
