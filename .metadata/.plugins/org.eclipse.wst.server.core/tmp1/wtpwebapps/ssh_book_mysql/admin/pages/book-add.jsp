...
<body>
	...
	<form action="bookAdd.action" method="post" enctype="multipart/form-data">
		...
		封面：<input type="file" name="photo" size="12" required="required"/><br><br>
		书名：<input type="text" name="book.name" required="required"/><br><br>
		价格：<input type="text" name="book.price" required="required"/><br><br>
		介绍：<input type="text" name="book.intro" required="required"/><br><br>
		作者：<input type="text" name="book.auther"/><br><br>
		出版社：<input type="text" name="book.press"/><br><br>
		出版日期：<input type="text" id="datepicker" name="book.pubdate"/><br><br>
		图书分类:  <select name="book.category.id">
					   ...
					   <br><br>
		<input type="submit" value="添加" style="color:green;margin-left:30px;"/>
		<input type="reset" value="重置" style="color:red;margin-left:30px;"/>
	</form><s:actionerror/>
